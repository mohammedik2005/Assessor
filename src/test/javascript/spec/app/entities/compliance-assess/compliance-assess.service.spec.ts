...
describe('Service Tests', () => {
    ...
    describe('ComplianceAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ComplianceAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/compliances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ComplianceAssess', () => {
