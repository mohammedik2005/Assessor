...
describe('Service Tests', () => {
    ...
    describe('AssessmentScheduleAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssessmentScheduleAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/assessment-schedules';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AssessmentScheduleAssess', () => {
