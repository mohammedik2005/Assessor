...
describe('Service Tests', () => {
    ...
    describe('PrinciplesAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrinciplesAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/principles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PrinciplesAssess', () => {
