...
describe('Service Tests', () => {
    ...
    describe('ComplianceEvidenceTypeAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ComplianceEvidenceTypeAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/compliance-evidence-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ComplianceEvidenceTypeAssess', () => {
