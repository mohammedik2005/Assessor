...
describe('Service Tests', () => {
    ...
    describe('ControlPriorityAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ControlPriorityAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/control-priorities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ControlPriorityAssess', () => {
