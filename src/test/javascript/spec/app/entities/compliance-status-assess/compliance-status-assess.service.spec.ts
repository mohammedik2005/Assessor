...
describe('Service Tests', () => {
    ...
    describe('ComplianceStatusAssess Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ComplianceStatusAssessService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/compliance-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ComplianceStatusAssess', () => {
