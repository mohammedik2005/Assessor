...
public class AttachmentResourceIntTest {
    ...
    private static final String DEFAULT_GENERATED_NAME = "AAAAAAAAAA";
    private static final String UPDATED_GENERATED_NAME = "BBBBBBBBBB";
    ...
    public static Attachment createEntity(EntityManager em) {
        Attachment attachment = new Attachment()
            ...
            .generatedName(DEFAULT_GENERATED_NAME)
    ...
    public void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getGeneratedName()).isEqualTo(DEFAULT_GENERATED_NAME);
        assertThat(testAttachment.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
        assertThat(testAttachment.getMimeType()).isEqualTo(DEFAULT_MIME_TYPE);
        assertThat(testAttachment.getOriginalName()).isEqualTo(DEFAULT_ORIGINAL_NAME);
        assertThat(testAttachment.getTableName()).isEqualTo(DEFAULT_TABLE_NAME);
        ...
        assertThat(testAttachment.getModifiedBy()).isEqualTo(DEFAULT_MODIFIED_BY);
    }
    ...
    public void getAllAttachments() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].generatedName").value(hasItem(DEFAULT_GENERATED_NAME.toString())))
    ...
    public void getAttachment() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments/{id}", attachment.getId()))
            ...
            .andExpect(jsonPath("$.generatedName").value(DEFAULT_GENERATED_NAME.toString()))
    ...
    public void updateAttachment() throws Exception {
        ...
        updatedAttachment
            ...
            .generatedName(UPDATED_GENERATED_NAME)
        ...
        assertThat(testAttachment.getGeneratedName()).isEqualTo(UPDATED_GENERATED_NAME);
        assertThat(testAttachment.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
        assertThat(testAttachment.getMimeType()).isEqualTo(UPDATED_MIME_TYPE);
        assertThat(testAttachment.getOriginalName()).isEqualTo(UPDATED_ORIGINAL_NAME);
        assertThat(testAttachment.getTableName()).isEqualTo(UPDATED_TABLE_NAME);
        ...
        assertThat(testAttachment.getModifiedBy()).isEqualTo(UPDATED_MODIFIED_BY);
    }
